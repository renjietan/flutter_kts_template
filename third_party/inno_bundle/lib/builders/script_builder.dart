...
\n''';
  ...
  /// Generates a [Code] section that brings the setup wizard to the foreground
  /// after the Windows UAC elevation prompt is accepted.
  String _bringToFront() {
    return r'''
[Code]
const
  SWP_NOSIZE = $0001;
...
function SetForegroundWindow(hWnd: LongWord): LongWord;
  external 'SetForegroundWindow@user32.dll stdcall';

function SetWindowPos(hWnd: LongWord; hWndInsertAfter: LongWord; X, Y, cx, cy: Integer; uFlags: LongWord): LongWord;
  external 'SetWindowPos@user32.dll stdcall';

procedure BringSetupToFront;
begin
